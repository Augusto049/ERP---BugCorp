...
public class adicionar_item_pedido_compra extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					adicionar_item_pedido_compra frame = new adicionar_item_pedido_compra();
	 ...
	 * Create the panel.
	 */
	public adicionar_item_pedido_compra() {
