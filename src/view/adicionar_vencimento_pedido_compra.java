...
public class adicionar_vencimento_pedido_compra extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					adicionar_vencimento_pedido_compra frame = new adicionar_vencimento_pedido_compra();
	 ...
	 * Create the panel.
	 */
	public adicionar_vencimento_pedido_compra() {
		...
		lblQuantidade = new JLabel("Pedido");
