...
public class adicionar_vencimento_pedido_venda extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					adicionar_vencimento_pedido_venda frame = new adicionar_vencimento_pedido_venda();
	 ...
	 * Create the panel.
	 */
	public adicionar_vencimento_pedido_venda() {
