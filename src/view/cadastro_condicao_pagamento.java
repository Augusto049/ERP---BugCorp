...
public class cadastro_condicao_pagamento extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					cadastro_condicao_pagamento frame = new cadastro_condicao_pagamento();
	 ...
	 * Create the panel.
	 */
	public cadastro_condicao_pagamento() {
		...
		btnSalvar.setBounds(109, 81, 89, 23);
