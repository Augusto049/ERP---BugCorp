...
public class cadastro_locais extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					cadastro_locais frame = new cadastro_locais();
	...
	public cadastro_locais() {
		...
		JLabel lblSetir = new JLabel("Endereçamento");
		lblSetir.setBounds(78, 70, 160, 12);
