...
public class contas_receber extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					contas_receber frame = new contas_receber();
	...
	public contas_receber() {
		...
		lblNewLabel_1_3.setBounds(259, 58, 106, 14);
		...
		lblNewLabel_1_3_1_1_1.setBounds(489, 58, 112, 14);
		contentPane.add(lblNewLabel_1_3_1_1_1);
		
		txtD = new JTextField();
		txtD.setColumns(10);
		txtD.setBounds(489, 73, 106, 20);
